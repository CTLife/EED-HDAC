...
my $HELP_g = '
        ...
        Usage:  
               perl  CISDA8-BAM-merge.pl    [-version]    [-help]    [-in inputDir]    [-out outDir]   
        For instance: 
               perl  CISDA8-BAM-merge.pl    -in 6-Merge     -out 9-BigWig-merge   >> CISDA8-BAM-merge.runLog  2>&1
...
my $output_g  = '9-BigWig-merge';     ## This is only an initialization  value or suggesting value, not default value.
...
if($boole_g == 1) {
    ...
    print   '    Please see help message by using "perl  CISDA8-BAM-merge.pl  -help". ';
    print "\n\n";
    exit 0;
}
