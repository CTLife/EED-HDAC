...
my $HELP_g = '
        ...
        Usage:  
               perl  CISDA9-merge.pl    [-v]    [-h]    [-i inputDir]    [-o outDir]   [-f format]  
        For instance: 
                     perl  CISDA9-merge.pl    -i 6-Merge          -o 10-MACS2-merge    -f BAM                    
                     perl  CISDA9-merge.pl    --input 6-Merge     --output 10-MACS2-merge  --format BAM   
                     perl  CISDA9-merge.pl    --input 6-Merge     --output 10-MACS2-merge  --format BAM     >> CISDA9-merge.runLog  2>&1
...
my $input_g   = '6-Merge';      ## This is only an initialization  value or suggesting value, not default value.
my $output_g  = '10-MACS2-merge';              ## This is only an initialization  value or suggesting value, not default value.
...
if($boole_g == 1) {
    ...
    print   '    Please see help message by using "perl  CISDA9-merge.pl  -h". ';
    print "\n\n";
    exit 0;
}
