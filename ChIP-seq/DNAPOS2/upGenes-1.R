...
mySample_g   <- "863upGenes";
myTitle_g    <- "TSSs of up-regulated genes";
myCenter_g   <- "TSS";
...
MyTheme_1 <- function(textSize1=14, hjust1=NULL, vjust1=NULL,  angle1=NULL) {    #hjust=1,    vjust=1,      angle=30
        theme(  
                ...
                #panel.margin.x     = grid::unit(1, "mm", data=NULL) ,
                #panel.margin.y     = grid::unit(1, "mm", data=NULL) ,
...
myNTR_withEquation_2 <- function( xAxis2,  yAxis2,   path2,  fileName2, titel2, xlab2, ylab2 ,yMin2=0, yMax2=0.7,   xMin2=0, xMax2=0.7 ) { 
  ...
  FigureTemp1 <- ggplot(data = dataFrame_NTR_point, aes(x = xAxis, y = yAxis)) + 
    ...
    ggtitle(titel2) + MyTheme_1( hjust1=1, vjust1=1,    textSize=12 )
  MySaveGgplot2_2(ggplot2Figure1=FigureTemp1,  path1=path2, fileName1=paste(fileName2, "-scatter-equation", sep="",  collapse=NULL),  height1=4, width1=4)
}
...
MyHistogram_3 <- function(vector2, path2,   fileName2,  title2,  xLab2,  height2=4,  width2=4,   xMin2=0,  xMax2=1.2,   yMin2=0,  yMax2=10) {
        ...
        FigureTemp3 <- ggplot(data=dataframeB, aes(x=xAxis) )  +  xlab(xLab2) + ylab("Probability density") +  ggtitle(title2)  +  
                ylim(yMin2, yMax2) +  geom_histogram( binwidth = 0.02, aes( y = (..density..), fill = ..count.. )  )  + scale_fill_gradient("Count", low = "green", high = "red") +
                scale_x_continuous(limits=c(xMin2, xMax2),  breaks=c(0, 0.3,  0.6, 0.9, 1.2), labels=c("0", "0.3",  "0.6", "0.9",   "1.2+") ) +  
                MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 ) 

        FigureTemp4 <- ggplot(data=dataframeB, aes(x=xAxis) )  +  xlab(xLab2) + ylab("Probability density") +  ggtitle(title2)  +  
                geom_histogram( binwidth = 0.02, aes( y = (..density..), fill = ..count.. )  )  + scale_fill_gradient("Count", low = "green", high = "red") +
                scale_x_continuous(limits=c(xMin2, xMax2),  breaks=c(0, 0.3,  0.6, 0.9, 1.2), labels=c("0", "0.3",  "0.6", "0.9",   "1.2+") ) +  
                MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 ) 
...
MyHistogram_4 <- function(vector2, sampleType2,  path2,   fileName2,  title2,  xLab2, height2=4,  width2=4,  xMin2=0,  xMax2=1.2,   yMin2=0,  yMax2=100, alpha2=0.5) {
        ...
        FigureTemp1 <- ggplot(data=dataframeB, aes(x=xAxis, fill=sampleType) )  + geom_histogram(binwidth = 0.05 , alpha=alpha2) +  
                xlab(xLab2) + ylab("Absolute frequency") +  ggtitle(title2)  +  
                ylim(yMin2, yMax2) +  geom_histogram( binwidth = 0.02, aes( y = (..count..) ) , alpha=alpha2 )  + 
                scale_x_continuous(limits=c(xMin2, xMax2),  breaks=c(0, 0.3,  0.6, 0.9, 1.2), labels=c("0", "0.3",  "0.6", "0.9",   "1.2+") ) +  
                MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 )   

        FigureTemp2 <- ggplot(data=dataframeB, aes(x=xAxis, fill=sampleType) )  + geom_histogram(binwidth = 0.05 , alpha=alpha2) +  
                xlab(xLab2) + ylab("Absolute frequency") +  ggtitle(title2)  +  
                geom_histogram( binwidth = 0.02, aes( y = (..count..) ) , alpha=alpha2 )  + 
                scale_x_continuous(limits=c(xMin2, xMax2),  breaks=c(0, 0.3,  0.6, 0.9, 1.2), labels=c("0", "0.3",  "0.6", "0.9",   "1.2+") ) +  
                MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 )  
...
MyHistogram_5 <- function(vector2, sampleType2,  path2,   fileName2,  title2,  xLab2, height2=4,  width2=4,  xMin2=0,  xMax2=1.2,   yMin2=0,  yMax2=10) {
        ...
        FigureTemp1 <- ggplot(data=dataframeB, aes(x=xAxis, fill=sampleType) )  + geom_histogram(binwidth = 0.05 , position="dodge") +  
                xlab(xLab2) + ylab("Probability density") +  ggtitle(title2)  +  
                ylim(yMin2, yMax2)  +  geom_histogram( binwidth = 0.02, aes( y = (..density..) )  )  + 
                scale_x_continuous(limits=c(xMin2, xMax2),  breaks=c(0, 0.3,  0.6, 0.9, 1.2), labels=c("0", "0.3",  "0.6", "0.9",   "1.2+") ) +  
                MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 )   

        FigureTemp2 <- ggplot(data=dataframeB, aes(x=xAxis, fill=sampleType) )  + geom_histogram(binwidth = 0.05 , position="dodge") +  
                xlab(xLab2) + ylab("Probability density") +  ggtitle(title2)  +  
                geom_histogram( binwidth = 0.02, aes( y = (..density..) )  )  + 
                scale_x_continuous(limits=c(xMin2, xMax2),  breaks=c(0, 0.3,  0.6, 0.9, 1.2), labels=c("0", "0.3",  "0.6", "0.9",   "1.2+") ) +  
                MyTheme_1( hjust1=NULL, vjust1=NULL,  angle1=NULL,   textSize=14 )  
...
MyQQplot_ggplot2_3 <- function(x2,  path2,  fileName2,  title2,  xLab2,  yLab2,   Ymin2=0,   Ymax2=10,   height2=3,  width2=4,  conf2=0.95,   dis2 = "norm" ) {  
        ...
        FigureTemp4 <- MyQQplot_ggplot2_2(x=x2, distribution = dis2, conf=conf2) +   
                xlab(xLab2) +  ylab(yLab2) +  ggtitle(title2) + ylim(Ymin2, Ymax2) +
                MyTheme_1(textSize1=14,  hjust1=NULL, vjust1=NULL,  angle1=NULL )  
        MySaveGgplot2_2(ggplot2Figure1=FigureTemp4,  path1=path2, fileName1=paste(fileName2, "-4",  sep="",  collapse=NULL),  height1=height2, width1=width2)
...
sink( paste(Part1_g,  "/1-1A-myAllFunctions.txt",  sep = "") )
cat('\n
MyTheme_1(textSize1=14, hjust1=NULL, vjust1=NULL,  angle1=NULL)
...
sink( paste(Part1_g,  "/1-2A-Versions.txt",  sep = "") )
sessionInfo()
sink()
