...
### Hugo Varet
### May 9th, 2016
### designed to be executed with SARTools 1.3.2
################################################################################
...
projectName <- "RAN-seq"                             # name of the project
author      <- "Yong Peng"                           # author of the statistical analysis/report

targetFile <- "target.txt"                           # path to the design/target file
rawDir     <- "1-rawCounts"                          # path to the directory containing raw counts files
